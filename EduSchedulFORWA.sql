...
COMMENT = 'Room types for different Educational activities:  Τα ' /* comment truncated */ /*διάφορα είδη αιθουσών του εκπαιδευτικού ιδρύματος, για διδασκαλία των μαθημάτων των σχολών και εκδηλώσεις.*/;
...
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_general_ci
COMMENT = 'The Buildings of the institution with the Floors of them, an' /* comment truncated */ /*d the rooms available for educational activities:  Τα κτήρια του Τ.Ε.Ι. με τους ορόφους του κάθε κτηρίου και οι διαθέσιμες αίθουσες του κάθε ορόφου για διδασκαλία μαθημάτων ή άλλες εκπαιδευτικές δραστηριότητες.*/;
...
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_general_ci
COMMENT = 'Institution Academic Titles of the Professors:  Ακαδιμ' /* comment truncated */ /*αϊκοί τίτλοι του Τ.Ε.Ι. στους μόνιμους εκπαιδευτικούς αλλά και στους έκτακτους εκπαιδευτικούς.*/;
...
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_general_ci
COMMENT = 'Available professors (Roster) as the staff of institution to' /* comment truncated */ /* be assigned lessons.*/;
...
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_general_ci
COMMENT = 'Schools of the institution:  Σχολές με τα τμήμ' /* comment truncated */ /*ατα που λειτουργούν στην σχολή και η διεύθηνση που εδρεύουν. Υπάρχει περίπτωση να υπάρχουν πρώην σχολές που σταμάτησαν να λειτουργούν πρόσφατα.*/;
...
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_general_ci
COMMENT = 'It is, what kind of teaching will use the professor in the t' /* comment truncated */ /*ime of event.*/;
...
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_general_ci
COMMENT = 'Time slot is the time from a chronological point and have a ' /* comment truncated */ /*duration, the event time.*/;
...
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_general_ci
COMMENT = 'Student groups have the group of stutents in semester catego' /* comment truncated */ /*ization. 
Student groups  table  could be connected with the Student table, in a seperate  database.*/;
...
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_general_ci
COMMENT = 'Institution departments are every functional part of the org' /* comment truncated */ /*nization, as the secretary, the technical support team. 
Επίσης συμπεριλαμβάνονται και οι σχολές του ΤΕΙ ως ξεχωριστό εκπαιδευτικό πεδίο μάθησης.*/;
...
CREATE TABLE IF NOT EXISTS `EventPlannedCourse_ScarceResource_ParticipantGroup_COMBIS` (
  ...
  PRIMARY KEY (`eventPlannedCourseID`, `scarceResourceID`, `schoolStudentGroupProfessorID`),
  ...
  CONSTRAINT `schoolStudentGroupProfessorID`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB
COMMENT = 'Event time scheduling in a Location of a room of the TEI wit' /* comment truncated */ /*h the registered Participants in the event.*/;
